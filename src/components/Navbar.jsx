...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Grid container sx={{width:'100vw',m:0, p:0,display:'flex',flexGrow:1,flexDirection:'row',alignItems:'center', my:scrollValue>150 ? 0 : 0, height:scrollValue>150 ? '60px' : '100px',transition:'0.5s'}}  spacing={1} >
                ...
                <Grid xs={6} sm={6}  md={3} sx={{}} >
                    <Item mr={2} sx={{ display:'flex', flexDirection: 'row',justifyContent:'start' }}>
                         ...
                         <Button variant="contained" className="" sx={{p:1,mr:1,width:'120px',height:'35px',color:'white'}}  endIcon={<LoginIcon />}>
                            login
                        </Button>
